...
export default function FinancialChat() {
  ...
  return (
    <KeyboardAvoidingView className="flex-1 justify-center items-center bg-acessiSecondary px-4">
      <View className="w-full h-[96%] justify-between items-center bg-white/40 border-[0.4px] border-[#854d0e77] rounded-lg px-2">
        {/* <ChatBackground color="#ca8a04" className="absolute w-full" /> */}

        <View className="flex flex-row border-b-1 border-l-acessiPrimary h-16 w-full bg-[#854d0e77] justify-between items-center px-4 rounded-xl my-4">
